...
final class DeleteCheckInApiActionTest extends BaseWebTestCase
{
    const uri = '/api/checking/check-ins/%s/';

    public function testDeleteCheckInApiActionFailsBecauseCheckInNotExists(): void
    {
    ...
    public function testDeleteCheckInApiActionSuccessfully(): void
    {
        ...
        $this->client->request('DELETE', sprintf(self::uri, $checkIn->id()->value));
