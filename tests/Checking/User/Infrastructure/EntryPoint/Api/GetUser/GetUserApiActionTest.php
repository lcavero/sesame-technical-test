...
final class GetUserApiActionTest extends BaseWebTestCase
{
    const uri = '/api/checking/users/%s/';

    public function testGetUserApiActionFailsBecauseUserNotExists(): void
    {
    ...
    public function testGetUserApiActionSuccessfully(): void
    {
        ...
        $this->client->request('GET', sprintf(self::uri, $user->id()->value));
